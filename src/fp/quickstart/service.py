"""Generic service quickstart node."""
...
class ServiceNode:
    def __init__(self, *, entity_id: str, server: FPServer | None = None) -> None:
        ...
        self.server.register_entity(make_default_entity(entity_id, EntityKind.SERVICE, display_name=entity_id))

    def endpoint(self, operation: str) -> Callable[[Callable[[dict[str, Any]], Any]], Callable[[dict[str, Any]], Any]]:
